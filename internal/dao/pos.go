...
type POS struct {
	ID                 uint64 `db:"id"`
	Category           rune   `db:"category"`
	Type               *rune  `db:"type"`
	Degree             *rune  `db:"degree"`
	Gender             *rune  `db:"gen"`
	Number             *rune  `db:"num"`
	PossessorPerson    *rune  `db:"possessorpers"`
	PossessorNumber    *rune  `db:"possessornum"`
	Person             *rune  `db:"person"`
	NounClass          *rune  `db:"neclass"`
	NounSubClass       *rune  `db:"nesubclass"`
	Case               *rune  `db:"case"`
	Polite             *rune  `db:"polite"`
	Mood               *rune  `db:"mood"`
	Tense              *rune  `db:"tense"`
	PunctuationEnclose *rune  `db:"punctenclose"`
}
